...
class LeNet(fluid.dygraph.Layer):
    def __init__(self, num_classes=12):
        ...
        self.conv1 = Conv2D(num_channels=3, num_filters=6, filter_size=5, act='sigmoid') ## 1-->3 for color image
        ...
        self.fc1 = Linear(input_dim=300000, output_dim=64, act='sigmoid')  ## 120-->300000 ## bigger image 28*28-->224*224
...
class VGG16(fluid.dygraph.Layer):
    def __init__(self,num_classes=12):
        ...
        self.block1_conv1_3_64 = ConvBNLayer(num_channels=3,num_filters=64,filter_size=3,act='relu')
        self.block1_conv2_3_64 = ConvBNLayer(num_channels=64,num_filters=64,filter_size=3,act='relu')
        self.block1_maxpool1= fluid.dygraph.Pool2D(pool_size=(2,2),pool_stride=2,pool_padding=0,pool_type='max')
        self.block2_conv1_3_128=ConvBNLayer(num_channels=64,num_filters=128,filter_size=3,act='relu')
        self.block2_conv2_3_128=ConvBNLayer(num_channels=128,num_filters=128,filter_size=3,act='relu')
        self.block2_maxpool1=fluid.dygraph.Pool2D(pool_size=(2,2),pool_stride=2,pool_padding=0,pool_type='max')
        self.block3_conv1_3_256=ConvBNLayer(num_channels=128,num_filters=256,filter_size=3,act='relu')
        self.block3_conv2_3_256=ConvBNLayer(num_channels=256,num_filters=256,filter_size=3,act='relu')
        self.block3_conv3_3_256=ConvBNLayer(num_channels=256,num_filters=256,filter_size=3,act='relu')
        self.block3_maxpool1=fluid.dygraph.Pool2D(pool_size=(2,2),pool_stride=2,pool_padding=0,pool_type='max')
        self.block4_conv1_3_512=ConvBNLayer(num_channels=256,num_filters=512,filter_size=3,act='relu')
        self.block4_conv2_3_512=ConvBNLayer(num_channels=512,num_filters=512,filter_size=3,act='relu')
        self.block4_conv3_3_512=ConvBNLayer(num_channels=512,num_filters=512,filter_size=3,act='relu')
        self.block4_maxpool1=fluid.dygraph.Pool2D(pool_size=(2,2),pool_stride=2,pool_padding=0,pool_type='max')
        self.block5_conv1_3_512=ConvBNLayer(num_channels=512,num_filters=512,filter_size=3,act='relu')
        self.block5_conv2_3_512=ConvBNLayer(num_channels=512,num_filters=512,filter_size=3,act='relu')
        self.block5_conv3_3_512=ConvBNLayer(num_channels=512,num_filters=512,filter_size=3,act='relu')
...
class ResNet(fluid.dygraph.Layer):
    def __init__(self, layers=50, num_classes=12):
        ...
        # 创建全连接层，输出大小为类别数目
        self.out = Linear(input_dim=2048, output_dim=num_classes,
